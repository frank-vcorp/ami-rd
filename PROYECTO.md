...
| fase0-panel-medico | Panel Médico MVS | FASE 0 – MVS | 0 | Frontend | pending | 0 | Maqueta navegable para que los médicos revisen datos y emitan reporte. Entregable: prototipo Next.js para demo interna (Sem 3). | Wireframes finales y usuarios médicos confirmados. |
