...
| fase0-ui-examen | UI Examen Médico | FASE 0 – MVS | 0 | Frontend | pending | 0 | Captura de signos vitales, somatometría y observaciones (layouts responsivos). Entregable: pestaña Examen Médico funcional. | Lista de campos y rangos confirmados por AMI. |
| fase0-ui-estudios | UI Estudios (SIM/NOVA) | FASE 0 – MVS | 0 | Frontend | pending | 0 | Drag & drop de archivos, barra de progreso y tarjetas de resultados simulados. Entregable: componente de carga + tabla de resultados. | Lista de estudios y archivos de ejemplo. |
| fase0-ui-validacion | UI Validación Médica | FASE 0 – MVS | 0 | Frontend | pending | 0 | Vista lado-a-lado PDF/datos, edición rápida y semáforos por parámetro. Entregable: flujo completo de validación listo para pruebas. | Reglas de semáforo y permisos de usuario médico. |
| fase0-ui-reportes | UI Reportes y Envío | FASE 0 – MVS | 0 | Frontend | pending | 0 | Pantalla para generar/descargar reportes completos, enviar por correo y ver logs. Entregable: pestaña Reportes con acciones disponibles. | Plantillas de correo y textos de notificación. |
